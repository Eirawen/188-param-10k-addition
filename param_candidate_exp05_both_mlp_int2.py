"""Baseline-derived candidate pruning both layer MLP widths from 3 -> 2."""

import param_343 as _p343
from param_candidate_utils import build_baseline_magic_model, prune_layer_mlp
...
def build_magic_model():
    ...
    prune_layer_mlp(model, 0, keep_units=(0, 1))
    prune_layer_mlp(model, 1, keep_units=(0, 1))
    model.eval()
    return model
