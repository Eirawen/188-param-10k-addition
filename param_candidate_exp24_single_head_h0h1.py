"""Exp24: single query head per layer (layer0=head0, layer1=head1) on top of Exp3."""
...
def build_magic_model():
    ...
    replace_layer_self_attn_single_query_head(model, 0, head_index=0)
    replace_layer_self_attn_single_query_head(model, 1, head_index=1)
